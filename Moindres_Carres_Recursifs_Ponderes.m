...
function [MCR1] = Moindres_Carres_Recursifs_Ponderes(N,B,A,B0,A0,alpha,lamda,bruit) 
...
for k=nb+1:N;
    ...
    TETA=[TETA,teta];
    P=(1/lamda)*(eye(na+nb)-G*h')*P;
end
%traçage des courbes 
n=na+nb;
f2 = figure('Name','Moindres_Carres_Recursifs_Ponderes');
for i=1:nb+na;
    subplot(na,nb,i)
